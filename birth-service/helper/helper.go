...
func ConnectDB() *mongo.Collection {
	...
	collection := client.Database(dbName).Collection("birth-regis")
	return collection
}
...
// GetErrorNotFound is a method for sending not found response
func GetErrorNotFound(err error, w http.ResponseWriter) {
	log.Fatal(err.Error())
	var response = ErrorResponse{
		ErrorMessage: err.Error(),
